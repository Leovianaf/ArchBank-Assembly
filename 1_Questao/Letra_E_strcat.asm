...
.text
	...
	concatenacao:
		...
		beq $t3, 10, concat	#ao achar a quebra de linha produzida na leitura de dest, pula pra função concat
		...
		beq $t2, $zero, nullch	#se achar caractere nulo em source pula pra função nullch
		j concat

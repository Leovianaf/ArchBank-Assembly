.data
   	...
   	COMANDO_NAO_EXISTE: .asciiz "\nO comando inserido n�o existe, tente novamente.\n"
   	LIMITE_ALTERADO_MSG: .asciiz "\nLimite alterado com sucesso. N�mero da conta: "
...
.text
	...
	main:
		...
		main_loop:
			...
			#li $v0, 4
   			...
   			#syscall
    			...
    			print_str(nomeBancoBanner)	# Imprime o banner "ArchBank-shell>> "
    	...
    	decodificaInput: # Funcao para decodificar o input inserido pelo cliente
        	...
        	# Para verificar se � conta_cadastrar
    	...
    	decodificaContaFormat:
    		...
    		la $a1, input_string # Source de memcpy
    		addi $a1, $a1, 13 # Endere�o do come�o do num da conta contido na string
    	...
    	decodificaDebitoExtrato:
    		li $a2, 8 # Num de bytes do num da conta a ser copiado
    		la $a1, input_string # Source de memcpy
    		addi $a1, $a1, 15 # Endere�o do come�o do num da conta contido na string
    		la $a0, contaComDigito # Destination de memcpy
    		jal memcpy # Chama memcpy
    	...
    	decodificaCreditoExtrato: 
    		li $a2, 8 # Num de bytes do num da conta a ser copiado
    		la $a1, input_string # Source de memcpy
    		addi $a1, $a1, 16 # Endere�o do come�o do num da conta contido na string
    		la $a0, contaComDigito # Destination de memcpy
    		jal memcpy # Chama memcpy
    	...
    	decodificaTransferirDebito:
    		...
    		li $a2, 8 # Num de bytes do num da conta a ser copiado
    		la $a1, input_string # Source de memcpy
    		addi $a1, $a1, 18 # Endere�o do come�o do primeiro num da conta contido na string
    		...
    		li $a2, 8 # Num de bytes do num da conta a ser copiado
    		la $a1, input_string # Source de memcpy
    		addi $a1, $a1, 27 # Endere�o do come�o do segundo num da conta contido na string
    		...
    		la $a1, input_string # Source de memcpy
    		addi $a1, $a1, 36 # Endere�o do come�o do valor contido na string
		...
		# Pra string da primeira conta
    		li $a2, 8 # Num de bytes do num da conta a ser copiado
    		la $a1, input_string # Source de memcpy
    		addi $a1, $a1, 19 # Endere�o do come�o do primeiro num da conta contido na string
    		la $a0, contaComDigito1 # Destination de memcpy
    		jal memcpy # Chama memcpy
    		...
    		li $a2, 8 # Num de bytes do num da conta a ser copiado
    		la $a1, input_string # Source de memcpy
    		addi $a1, $a1, 28 # Endere�o do come�o do segundo num da conta contido na string
    		la $a0, contaComDigito2 # Destination de memcpy
    		jal memcpy # Chama memcpy
    		...
    		li $a2, 6 # Num de bytes do valor a ser copiado
    		la $a1, input_string # Source de memcpy
    		addi $a1, $a1, 37 # Endere�o do come�o do valor contido na string
    		la $a0, valor # Destination de memcpy
    		jal memcpy # Chama memcpy
    	...
    	decodificaPagarFatura:
    		...
    		la $a1, input_string # Source de memcpy
    		addi $a1, $a1, 22 # Endere�o do come�o do valor contido na string
    		la $a0, valor # Destination de memcpy
    		jal memcpy # Chama memcpy
    		
    		li $a2, 1 # Num de bytes do metodo a ser copiado
    		la $a1, input_string # Source de memcpy
    		addi $a1, $a1, 29 # Endere�o do metodo de pagamento contido na string
    	...
    	decodificaSacar:
    		li $a2, 8 # Num de bytes da conta a serem copiados
    		la $a1, input_string # Source de memcpy
    		addi $a1, $a1, 6 # Endere�o do come�o do num da conta contido na string
    		la $a0, contaComDigito # Destination de memcpy
    		jal memcpy # Chama memcpy
    		
    		li $a2, 6 # Num de bytes do valor a serem copiados
    		la $a1, input_string # Source de memcpy
    		addi $a1, $a1, 15 # Endere�o do come�o do valor contido na string
    		la $a0, valor # Destination de memcpy
    		jal memcpy # Chama memcpy
	...
	decodificaDepositar:
		li $a2, 8 # Num de bytes da conta a serem copiados
    		la $a1, input_string # Source de memcpy
    		addi $a1, $a1, 10 # Endere�o do come�o do num da conta contido na string
    		la $a0, contaComDigito # Destination de memcpy
    		jal memcpy # Chama memcpy
    		
    		li $a2, 6 # Num de bytes do valor a serem copiados
    		la $a1, input_string # Source de memcpy
    		addi $a1, $a1, 19 # Endere�o do come�o do valor contido na string
    		la $a0, valor # Destination de memcpy
    		jal memcpy # Chama memcpy
    	...
    	decodificaAlterarLimite:
    		...
    		li $a2, 6 # Num de bytes do valor a serem copiados
    		la $a1, input_string # Source de memcpy
    		addi $a1, $a1, 24 # Endere�o do come�o do valor contido na string
    		la $a0, valor # Destination de memcpy
    		jal memcpy # Chama memcpy
    	...
    	decodificaDataHora:
    		...
    		la $a1, input_string # Source de memcpy
    		addi $a1, $a1, 10 # Endere�o do come�o da data/hora contida na string
    		la $a0, data # Destination de memcpy
    		jal memcpy # Chama memcpy
    		
    		li $a2, 6 # Num de bytes da hora a serem copiados
    		la $a1, input_string # Source de memcpy
    		addi $a1, $a1, 19 # Endere�o do come�o da data/hora contida na string
